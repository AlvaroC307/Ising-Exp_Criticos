...
def main():
    ...
    beta = list_Input[5] # Inversa de la temperatura, hemos tomado k=1
    pintar_intermedios = bool(int(list_Input[6])) # Variable que nos dice si pintar los pasos intermedios o no
    loop_T = int(list_Input[7]) # Cantidad de puntos en los que se ejecuta el loop de temperaturas
    temp_i = list_Input[8]
    temp_f = list_Input[9]
